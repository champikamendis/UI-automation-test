...
public class UiAutomationTrainingBasicTest extends TestBase {
	...
	public void testVerifyLogin() {
		...
		softAssert = new SoftAssert();
		softAssert.assertTrue(HomePage.isHomePageDisplayed(),"Home Page is Displayed");

		HomePage.clickLink(Constants.LOGIN_LINK);
		softAssert.assertTrue(LoginPage.isLoginPageDisplayed(),"Login Page is Displayed");

		LoginPage.setUsernamePassword(Constants.LOGIN_USER_NAME, Constants.LOGIN_PASSWORD);

		LoginPage.clickSubmit();

		softAssert.assertTrue(LoginSecurePage.isLoginSecurePageDisplayed(), "Login Secure Page is Displayed");

		softAssert.assertTrue(LoginSecurePage.isAlertDisplayed(),"Login Alert is Displayed");

		softAssert.assertTrue(LoginSecurePage.getAlertContent().contains(Constants.LOGIN_SUCCESS_MSG),"Login Alert Message is correct");

		LoginSecurePage.clickLogout();

		softAssert.assertTrue(LoginPage.isLoginPageDisplayed(),"Login Page is Displayed");

		softAssert.assertTrue(LoginPage.isAlertDisplayed(),"Logout Alert is Displayed");

		softAssert.assertTrue(LoginPage.getAlertContent().contains(Constants.LOGOUT_SUCCESS_MSG),"Logout Message is correct");
